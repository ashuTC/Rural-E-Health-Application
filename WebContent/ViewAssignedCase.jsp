      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="header">DOCTOR PANEL</li>
              <li class="treeview">
                <a href="ViewAssignedCase.jsp">
                <i class="fa fa-edit"></i> <span>View Case</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                
              </li>
              <li class="treeview">
                <a href="GoToDocCase.jsp">
                <i class="fa fa-edit"></i> <span>View Specific Case</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                
              </li>
			  <li class="treeview">
                <a href="AddCommentA.jsp">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Patient Cases:</h2>
				...
				try
				{
					PreparedStatement ps1=con.prepareStatement("select * from patientdetail  ");

					ResultSet rs=ps1.executeQuery();
					
					while(rs.next())
						{
						if(rs.getString(12).equals(UserInfo.getdName()))
						{
						System.out.println("hello inloop");
						%>
						<tr class="danger">
						<td><%=rs.getInt("Pid") %></td>
						...
						<td><%=rs.getString("Symptom_1") %></td>
						<td><%=rs.getString("Symptom_2") %></td>
						<td><%=rs.getString("Symptom_3") %></td>
						<td><%=rs.getString("Symptom_4") %></td>
						</tr>
						<%
						}					
							}
