...
try
{
	...
	// UserInfo.setpId(Integer.parseInt(request.getParameter("pid")));
	 while(rs1.next())
	 {
...
%> 
							 ...
							 <br>
				<button type="button" ><a href="AddCommentA.jsp">Comment</a></button>
				<button type="button" ><a href="upload_image.jsp">Prescription</a></button>
				</div>
