...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Arogya List:</h2>
...
try
{
	PreparedStatement ps1=con.prepareStatement("select * from arogyavibhag");
...
%> 
		...
		<!--footer-->
		<div class="footer">
		   <p>&copy; 2022. All Rights Reserved | Design by <a href="" target="_blank">Ashvini Chintewad</a></p>
	   </div>
        <!--//footer-->
	</div>
