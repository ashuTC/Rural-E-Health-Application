...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Add Comment:</h2>
				...
				try
				{
					PreparedStatement ps1=con.prepareStatement("select * from comment where pid=? and dname=?");
				...
				%>
				<input type="text" class="user" name="com" placeholder="Enter your comment"><br>
